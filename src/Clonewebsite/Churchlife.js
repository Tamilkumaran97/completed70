        ...
        <div className="z-10 relative bg-[#F1E4EB] ">
          <div className="w-[100%] overflow-hidden">
            ...
            >
              <h1
                ref={ref}
                className="absolute head uppercase squad text-9xl  lg:text-[190px] text-center w-[100%] bottom-2 text-white"
              >
                Church life
              </h1>
              <motion.div
          ...
          {/**second container */}
          <div className="w-[100%] mt-24  flex justify-center items-center ">
            <div className="text-center px-16 ">
              <div className=" lg:px-52 xl:px-72 ">
                <h1 className="text-5xl xl:text-6xl font-bold">Church life</h1>
              ...
              <div className="flex-col-2 lg:px-10">
                <Link to="1" smooth={true} duration={1000}>
                  <button className="mt-12 lg:mt-20 w-[300px] xl:w-[350px] mr-4 py-4 xl:py-6 hover:bg-black hover:text-white bg-white uppercase font-semibold border-2 border-black rounded-full">
                    SOUL KIDS
                  </button>
                </Link>
          ...
          <div className="relative w-[100%] py-16 bg-[#F1E4EB] border-b-4 border-black">
            ...
            <div className="">
              ...
              <div
                ref={scale}
                id="1"
                className="sticky w-[100%] h-[100vh] top-0 p-10 flex justify-center"
              >
                <div className="h-[600px] rounded-3xl w-[1100px] bg-[#BDB3B3] flex  overflow-hidden ">
              ...
              <div
                id="2"
                ref={scale1}
                className="sticky w-[100%] h-[100vh] top-4 p-10 flex justify-center"
              >
                <div className="h-[600px] rounded-3xl w-[1140px] bg-[#C6BEBE] flex  overflow-hidden ">
                  <div className="w-1/2 p-10">
              ...
              <div
                id="3"
                ref={scale2}
                className="sticky w-[100%] h-[100vh] top-8 p-10 flex justify-center"
              >
                <div className="h-[600px] rounded-3xl w-[1180px] bg-[#D2CBCB]  flex  overflow-hidden ">
                  <div className="w-1/2 p-10">
              ...
              <div
                id="4"
                ref={scale3}
                className="sticky w-[100%] h-[100vh] top-12 p-10 flex justify-center"
              >
                <div className="h-[600px] rounded-3xl w-[1220px] bg-[#BDB3B3] flex  overflow-hidden ">
                  <div className="w-1/2 p-10">
                    <h1 className="text-4xl font-bold ">
                      Give to <br />
                      SOUL Church
              ...
              <div
                id="5"
                ref={scale4}
                className="sticky w-[100%] h-[100vh] top-14 p-10 flex justify-center"
              >
                <div className="h-[600px] rounded-3xl w-[1260px] bg-[#C6BEBE] flex  overflow-hidden ">
                  <div className="w-1/2 p-10">
                    <h1 className="text-4xl font-bold ">Our new home</h1>
                    <p className="pt-32 pb-4">
                      We’re building a home for the people of Norwich, where
              ...
              <div
                id="6"
                ref={scale5}
                className="sticky w-[100%] h-[100vh] top-18 p-10 flex justify-center"
              >
                <div className="h-[600px] rounded-3xl w-[1300px] bg-[#D2CBCB]  flex  overflow-hidden ">
                  <div className="w-1/2 p-10">
                    <h1 className="text-4xl font-bold ">Soul Foundation</h1>
                    <p className="pt-32 pb-4">
                      We love the people of our city and we aim to keep our
